/*!
 * \file CMMSNSTwoHalfSpheresSolution.hpp
...
/*!
 * \class CMMSNSTwoHalfSpheresSolution
 * \brief Class to define the required data for the manufactured solution of the
          laminar Navier-Stokes equations on the domain between two half spheres.
 * \author E. van der Weide, T. Economon
 */
class CMMSNSTwoHalfSpheresSolution final : public CVerificationSolution {
 protected:
 ...
 public:
   ...
   */
  CMMSNSTwoHalfSpheresSolution(unsigned short val_nDim, unsigned short val_nvar, unsigned short val_iMesh,
                               CConfig* config);
